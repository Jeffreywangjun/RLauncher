...
// wangjun add end
    ...
    private void init() {
// wangjun add begin JEFF_RECT_FOLDER
        jeff_is_rect_folder=getResources().getBoolean(R.bool.jeff_is_rect_folder);

        if (jeff_is_rect_folder) {
...
// wangjun add begin JEFF_RECT_FOLDER
        ...
        if (!jeff_is_rect_folder) {
            ...
            float leftMargin = (mAvailableSpaceInPreview - mAvailableSpaceInFolderIcon) / 2-3;
